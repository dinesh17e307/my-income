                    ...
                    this.state.openModal && (
                        <Dialog open >
                            ...
                            <DialogContent>
                                ...
                                <Grid container>
                                    <Grid xs={12} lg={6}>
                                        <TextField className={classes.width} id="bidOwner" variant='outlined' label="ஏல உரிமையாளர்" placeHolder="rate" required onChange={(event) => this.onChangehandler(event)} />
                                    </Grid>
                                    <Grid xs={12} lg={6}>
                                        <TextField className={classes.width} id="nickName" variant='outlined' label="ஏலத்தின் பெயர்" placeHolder="rate" required onChange={(event) => this.onChangehandler(event)} />
                                    </Grid>
                                    <Grid xs={12} lg={6}>
                                        <TextField className={classes.width} id="totalAmount" variant='outlined' label="மொத்த தொகை" placeHolder="rate" required onChange={(event) => this.onChangehandler(event)} />
                                    </Grid>
                                    <Grid xs={12} lg={6}>
